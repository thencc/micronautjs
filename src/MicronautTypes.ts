...
export interface MicronautLsigCallAppArguments
  extends MicronautCallAppArguments {
  lsig: LogicSigAccount;
}
...
export interface MicronautLsigSendAssetArguments
  extends MicronautSendAssetArguments {
  lsig: LogicSigAccount;
}
...
export interface MicronautLsigPaymentArguments
  extends MicronautPaymentArguments {
  lsig: LogicSigAccount;
}
